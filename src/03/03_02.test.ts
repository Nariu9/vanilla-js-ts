...
test('Greeting should be correct for city', () => {
   ...
   /* expect(message).toBe("Hello New York citizens. I want all 1000000 of you to be happy")*/
    expect(createMessage(city)).toBe("Hello New York citizens. I want all 1000000 of you to be happy")
});
